...
public class Cow extends Animals {
    ...
    public String toString() {
        if (grass != null && getLoaiVN() == grass.getLoaiThucAn()) {
            return String.format("%-10s %-15s %-10s %-12s %-10s %-10d %-10d %-10d %-10s %-10s", maVN, name, LoaiVN,
            ...
            return String.format(" %-14s %-20s %-15s %-15s %-15d %-15d %-20d %-20s %-20s", maVN, name, LoaiVN, " ",
                    TrongLuong, SoLuong, getSanLuongSua(),"X", getSanLuongThit());
        }
    }
